...
/*  Created On : 05-feb.-2022 12:11:00 p. m. 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */

CREATE DATABASE `cofftea`; /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
(
	`id_category_product` INT NOT NULL DEFAULT auto_increment,
...
(
	`id_invoice_detail` INT NOT NULL DEFAULT auto_increment,
...
(
	`id_products` INT NOT NULL DEFAULT auto_increment,
...
(
	`id_profile` INT NOT NULL DEFAULT auto_increment,
	`description` VARCHAR(100) NOT NULL,
	`name` VARCHAR(50) NULL,
...
(
	`id_sales_invoice` INT NOT NULL DEFAULT auto_increment,
...
(
	`id_type_product` INT NOT NULL DEFAULT auto_increment,
	`description` VARCHAR(100) NOT NULL,
	`name` VARCHAR(50) NULL,
